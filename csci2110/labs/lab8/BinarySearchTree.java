...
public class BinarySearchTree<T extends Comparable<T>>{
    ...
    */
    ...
    public BinaryTree<T> recursiveSearch(BinaryTree<T> t, T key) {
    	//ToDo
		if(t == null || t.isEmpty() || key == null) return null;
		int c = key.compareTo(t.getData());
		if(c < 0) return recursiveSearch(t.getLeft(), key);
		if(c > 0) return recursiveSearch(t.getRight(), key);
		else return t;
    }
}
